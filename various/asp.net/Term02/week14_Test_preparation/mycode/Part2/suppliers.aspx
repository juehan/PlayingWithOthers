    ...
    <div id="wrapper">
        ...
        <div id="content">
            <asp:GridView ID="gvSupplier" runat="server" AutoGenerateColumns="False" CellPadding="4"
                DataKeyNames="SupplierID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="SupplierID" DataNavigateUrlFormatString="productsBySupliers.aspx?SupplierID={0}"
