<%@ Page Language="C#" AutoEventWireup="true" CodeFile="01CreatingDataListControl.aspx.cs" Inherits="_01CreatingDataListControl" %>
...
<body>
    ...
    <br />
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" CellPadding="5" RepeatColumns="3">
